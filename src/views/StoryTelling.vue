  ...
  <div class="storytelling-container">
    ...
    <div class="storytelling-content">
      <div class="text-image-container">
        ...
        <p v-if="showContent" class="storytelling-title">Sharon</p>
        <p v-if="showContent" class="storytelling-description">
    ...
    <button @click="showContent = true" class="storytelling-button">Next</button>
  </div>
</template>
...
.storytelling-container {
  @apply w-full h-[605px] sm:h-[595px] xl:h-[695px] flex flex-col justify-center items-center relative -mt-[60px] z-50 bg-[#0c2977];
}
...
.storytelling-title {
  @apply absolute top-[25px] sm:top-[30px] md:top-[32px] xl:top-[37px] left-[95px] sm:left-[123px] xl:left-[118px] text-xs sm:text-lg xl:text-[25px] pl-0 sm:pl-[30px] text-white font-medium;
}
...
.storytelling-button {
  @apply w-[75px] xl:w-[100px] h-[40px] xl:h-[50px] border-white border-[1px] xl:border-2 border-solid rounded-tr-[15px] rounded-bl-[15px] xl:font-medium text-base xl:text-[22px] text-white absolute bottom-5 sm:bottom-1 xl:bottom-6 right-5 sm:right-2 xl:right-16;
}
</style>
