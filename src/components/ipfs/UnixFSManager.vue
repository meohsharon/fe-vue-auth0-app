<template>
  <div class="w-full bg-white shadow sm:rounded-lg">
    ...
    <div>
      ...
      <button id="newDirButton" @click="handleNewDir">
    ...
    <div v-if="dirCid">
      <button id="getDirButton" @click="handleGetDirectory(dirCid, '')">
        list Directory
      </button>
    ...
    <div v-if="fileDirCid">
      ...
      <p id="dirContentsOutput" v-for="(item, index) in directoryContents">
