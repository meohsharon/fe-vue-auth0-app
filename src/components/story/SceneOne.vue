<template>
  ...
  <div class="hotspot top-[40vh] left-64 max-[360px]:top-[40vh] max-[380px]:top-[47vh] max-[500px]:top-[39vh] max-[500px]:left-[20vw] max-[600px]:top-[55vh] max-[900px]:top-[25vh] max-[900px]:left-32 md:top-[25vh] md:left-44 lg:top-[45%] lg:left-56 xl:top-90 xl:left-[20%] 2xl:left-[20%]" @click="show = true">
    <span
